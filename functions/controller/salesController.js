...
exports.addSale = (req, res) => {
  ...
  if (token === undefined) {
    ...
    try {
      ...
      // execute query
      const query = `INSERT INTO ventas ( monto_neto, monto_imp, costo_neto, costo_imp, tipo_documento, documento, cliente, medio_pago, usuario) VALUES (${monto_neto}, ${monto_imp}, ${costo_neto}, ${costo_imp}, '${tipo_documento}', '${documento}', '${cliente}', ${medio_pago}, ${uid})`;
      console.log(query);
      connection.query(query, (err, result, fields) => {
        ...
        productos.forEach((producto) => {
          ...
          const query2 = `UPDATE articulos SET stock = stock - ${producto.quantity} WHERE id = ${producto.id}`;
          console.log(query2);
          ...
          const query3 = `INSERT INTO detalle_movimientos_articulos (movimiento_id, id_movimiento, producto_id, cantidad, usuario_id, created_at, updated_at) VALUES ('2', '${venta_id}', '${producto.id}', '${producto.quantity}', '${uid}',  NOW(), NOW())`;
          console.log(query3);
